  ...
  return (
    <div ref={container} className="px-6 md:px-0 mt-40 md:mt-60 text-[var(--color-brand-Blue)]">
      ...
      <p className="animate-text text-brand-white font-brandBody md:text-[30px] leading-[1.6] mb-10">
        Sorry, we couldn’t find the page you were looking for. It may have been moved, deleted or the link may be incorrect. Please try again soon or get in touch if you need immediate support.
      </p>
